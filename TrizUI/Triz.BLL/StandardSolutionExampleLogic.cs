...
namespace Triz.BLL
{
    public class StandardSolutionExampleLogic
    {
        ...
        public string GetTreeData(string ProjectID)
        {
            List<StandardSolutionExampleInfo> Fathers = GetFathers(ProjectID);
        ...
        private List<StandardSolutionExampleInfo> GetFathers(string ProjectID)
        {
            return new StandardSolutionExampleDAL().GetFathers(ProjectID);
        }
